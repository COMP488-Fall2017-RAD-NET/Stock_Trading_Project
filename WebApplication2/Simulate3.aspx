<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Simulate3.aspx.cs" Inherits="WebApplication2.Simulate3" %>
        ...
        <fieldset>
            ...
            <div class="form-group">
                <div style="padding-top: 10px; padding-bottom: 10px">
                    ...
                    <asp:Button ID="getQuote" runat="server" Text="Submit" OnClick="GetQuote_Click" type="submit" class="btn btn-primary"/>
                </div>
            ...
            <div class="form-group">
                ...
                <div style="padding-top: 5px; padding-bottom: 5px">
                    ...
                    <input id="amount" runat="server" type="text" class="form-control" readonly="true" style="padding: 10px" />
